...
@section('body')
    <div class="d-flex flex-wrap justify-content-center">
        ...
        @foreach ($cartHeaders as $cartHeader)
            <div class="card mb-3 mt-4 w-75 p-5">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    ...
                    @foreach ($cartHeader->cartDetail as $cartDetail)
                        <div class="row align-items-center border rounded m-1 p-1">
                            <div class="col-md-4">
                            {{-- img size has to be changed --}}
                            <img src="{{url('storage\app\public\images\books\\'.$cartDetail->book->photoPath)}}" class="img-fluid rounded-start" alt="{{$cartDetail->book->title}}">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
